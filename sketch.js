var game = new Phaser.Game(400, 700, Phaser.CANVAS, '', { preload: preload, create: create, update: update });
...
function create() {
  ...
  game.physics.p2.gravity.y = 0;
	...
	game.stage.backgroundColor = "#hefew0o";

	// high_score_text = game.add.text(450, 25, 'High Score\n' + high_score, { font: 'Arial', fontSize: '32px', fill: '#000', align: 'right' });
	current_score_text = game.add.text(297, 12, '', { font: 'Arial', fontSize: '40px', fill: '#4287f5', align: 'right' }); // 300, 500
	current_best_text = game.add.text(233,21, '', { font: 'Arial', fontSize: '20px', fill: '#4287f5', align: 'right' });// 230, 450
	current_best_score_text = game.add.text(297, 29, '', { font: 'Arial', fontSize: '40px', fill: '#4287f5', align: 'right' }); // 300, 500

	hoop = game.add.sprite(88, 62, 'hoop'); // 141, 100
	left_rim = game.add.sprite(150, 184, 'side rim'); // 241, 296
	right_rim = game.add.sprite(249, 174, 'side rim'); // 398, 296
